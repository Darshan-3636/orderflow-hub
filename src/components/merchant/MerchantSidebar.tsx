...
const employeeItems: NavItem[] = [{ to: "/merchant/kds", label: "Cook Mode", icon: ChefHat }];
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <Link
          to="/merchant"
          className="flex min-w-0 items-center justify-center gap-2 px-2 py-2 data-[expanded=true]:justify-start"
        ...
        >
          ...
          {!collapsed && (
            <span className="min-w-0 truncate font-display text-base font-semibold">Merchant</span>
          )}
        </Link>
      </SidebarHeader>
      <SidebarContent>
